---
title: Blog Elements
subtitle: What I Use to Create My Posts
slug: blog-elements
tags: incredible-machine, version-control
intent: showcase
stance: neutral
affiliation: affiliate
audience: everyone
keywords: These, Are Some, Keywords
published: 1701421200000
updated: 1701507600000
reviewed: 1701594000000
draft: true
---

<BlogWrapper frontmatter={frontmatter} readingTime={readingTime}>
...
<CodeGroup titles={['sample.js', 'another-tab.ts']}>
...
// Hello
// I'm shy
// Would you please hide me again?
```
...
<Sandbox title="Editable Code is Cool Too" showLineNumbers files={{
  '/App.js': `export default function App() {
  return (
    <div className="flex h-screen items-center justify-center bg-[#282a36]">
      <h1 className="text-xl font-semibold text-slate-300">I can haz editz?</h1>
    </div>
  );
}
`}} />
...
<Terminal>
<Line prefix="$">pnpm run dev</Line>
<Line color="success">Started!</Line>
<Line>Let's see if it errors...</Line>
<Line color="warning">Something's up...</Line>
<Line highlight="error">Yeah, that's not good.</Line>
<Line>Time to start over.</Line>
<Line prefix="$">_</Line>
</Terminal>
