  ...
  return (
    <div className="hero">
      <div className="hero-content max-w-5xl flex-row gap-16">
        <Badvatar className="shadow-halo-error hidden h-64 w-64 rounded-3xl lg:avatar" />
        <div>
          <Badvatar className="shadow-halo-error-sm avatar mb-6 h-16 w-16 rounded-full xs:hidden" />
          <p>Oh, looks like</p>
          ...
          <div className="mt-6 flex flex-row items-center justify-start gap-4">
            <Badvatar className="shadow-halo-error-sm mr-4 hidden h-16 w-16 rounded-full xs:avatar sm:h-20 sm:w-20 lg:hidden" />
            <SuperLink
              href="/"
              className="shadow-halo-error btn btn-primary"
              onClick={() => reset()}
            >
              Try again
            </SuperLink>
